# animation1
<div dir="rtl">
 در این بخش روش های مختلفی را جهت ایجاد نمودارهای متحرک با استفاده از محیط آر بیان خواهیم کرد.انیمیشن  عنصر بسیار مهم تجسم داده 
...
از آن جهت که محیط آر متن باز  است، میتوانیم آن را به صورت رایگان بارگیری کنیم و بدون انتقال اطلاعات به سرور، نمودارهای متحرک ایجاد کنیم.

یکی از روشهایی که میتوانیم در محیط آر نمودارهای متحرک ایجاد کنیم، استفاده از بسته
{gganimate} است.
